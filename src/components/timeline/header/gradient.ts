...
export function headerGradient(mode: ResolvedMode, background: string): GradientProps {
  return mode === "dark"
    ? {
...
export function screenGradient(mode: ResolvedMode, background: string): GradientProps {
  return mode === "dark"
